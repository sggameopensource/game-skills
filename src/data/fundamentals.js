export const fundamentalsCollection = {
	...
	areas: [
		...
		},
		{
			...
			skills: [
				{
					name: "커맨드라인 인터페이스, 셸, 터미널",
					description: {
						text: "터미널 사용 및 학습시 자주 듣게되는 용어인 커맨드라인 인터페이스, 셸, 터미널이라는 용어를",
						links: [
							["참고자료", "https://www.44bits.io/ko/keyword/command-line-interface-cli-shell-and-terminal"],
						]
					}
				},
			]
